...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_tkl_iso(
    KC_ESC,  KC_BRMD,   KC_BRMU,  KC_LPAD,   KC_MCTL,   KC_F5,   KC_F6,   KC_MPRV,  KC_MPLY,   KC_MNXT,   KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_PSCR, MO(_LED), KC_PAUS,
  ...
  [_LED] = LAYOUT_tkl_iso(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_TRNS, KC_TRNS, KC_TRNS,
